    ...
    payload: {
      ...
      buttons: [
        ...
        },
        {
          ...
          title: 'Airtel 100MB',
          payload:
            '{"title": "referralBonusOfferSelected", "network": "Airtel", "size": "100MB", "networkID": "3", "planID": "40004", "refereeId": "${refereeId}"}',
        },
      ],
    },
  };
    ...
    payload: {
      ...
      buttons: [
        ...
        },
        {
          ...
          title: '9mobile 500MB',
          payload:
            '{"title": "referralBonusOfferSelected", "network": "9mobile", "size": "500MB", "networkID": "4", "planID": "40004", "refereeId": "${refereeId}"}',
        },
      ],
    },
  };
...
export { referralOffers1, referralOffers2, referralTemp };
