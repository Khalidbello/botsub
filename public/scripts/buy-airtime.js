...
function networkSelected(ele) {
  ...
  switch(ele.dataset.network) {
    case "mtn":
      networkBox.innerHTML =  "<option value='mtn' "
        +"selected hidden disabled>MTN</option>";
    ...
    case "airtel":
      networkBox.innerHTML = 
        "<option value='airtel' "
        + "selected hidden disabled>Airtel</option>";
      networkBox.dataset.network = "airtel";
      networkBox.dataset.networkID = "4";
      break;
    case "glo":
      networkBox.innerHTML=  "<option value='glo' "
        +"selected hidden disabled>Glo</option>";
