...
function networkChange() {
  ...
  offerBox.innerHTML = "<option selected hidden"
   +" value='empty' disabled>••••••••</option>";
...
async function getContact() {
  ...
  event.preventDefault();handlePhoneError();
  /*try {
    contact = await
...
function txCode() {
  let code = "";
  let characters = "qwertyuiopasdfghjklzxcvbnm0987654321";
  for (let x = 0; x < 25; x++) {
